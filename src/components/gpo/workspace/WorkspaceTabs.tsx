...
const WorkspaceTabs: React.FC<WorkspaceTabsProps> = ({ activeTab, onTabChange }) => {
  ...
  return (
    <Tabs value={activeTab} onValueChange={onTabChange} className="space-y-4 sm:space-y-6">
      <div className="overflow-x-auto">
        <TabsList className="grid w-full grid-cols-5 min-w-max">
          ...
          <TabsTrigger value="negotiations" className="text-xs sm:text-sm px-2 sm:px-4">
            {language === 'ar' ? 'المفاوضات' : 'Negotiations'}
          </TabsTrigger>
      ...
      <TabsContent value="negotiations">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">{language === 'ar' ? 'المفاوضات النشطة' : 'Active Negotiations'}</CardTitle>
      ...
      <TabsContent value="contracts">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">{language === 'ar' ? 'العقود الذكية' : 'Smart Contracts'}</CardTitle>
            <CardDescription className="text-sm sm:text-base">
              {language === 'ar' 
      ...
      <TabsContent value="arbitration">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">{language === 'ar' ? 'تحكيم ORDA' : 'ORDA Arbitration'}</CardTitle>
            <CardDescription className="text-sm sm:text-base">
              {language === 'ar' 
      ...
      <TabsContent value="analytics">
        <Card>
          <CardHeader>
            <CardTitle className="text-lg sm:text-xl">{language === 'ar' ? 'تحليلات الأعمال' : 'Business Analytics'}</CardTitle>
            <CardDescription className="text-sm sm:text-base">
              {language === 'ar' 
